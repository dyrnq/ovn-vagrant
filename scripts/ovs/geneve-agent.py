...
class EtcdClient:
    ...
    def keepalive(self):
        """Refresh the lease."""
        if self.lease_id:
            self.client.post("/v3/lease/keepalive",
...
def main():
    ...
    # 3. Check persistent allocation (survives reboot/lease expiry)
    ...
    # 9. Watch for peer changes (blocks)
